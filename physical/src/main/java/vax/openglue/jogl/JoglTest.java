...
public class JoglTest implements GLEventListener, KeyListener {
    ...
    private final String SHADERS_ROOT = "https://raw.githubusercontent.com/elect86/jogl-samples/master/jogl-samples/src/helloTriangle/shaders";
            //"/shader";
    /**
    ...
    public JoglTest () {
        ...
        //JoglTest helloTriangle = new JoglTest();
    ...
    private void initProgram ( GL4 gl4 ) {
        ShaderCode vertShader = ShaderCode.create( gl4, GL_VERTEX_SHADER, this.getClass(), SHADERS_ROOT, null, "vs", "glsl", null, true );
        ShaderCode fragShader = ShaderCode.create( gl4, GL_FRAGMENT_SHADER, this.getClass(), SHADERS_ROOT, null, "fs", "glsl", null, true );
